...
void integMain(UiPeripheralAgent uiPeripheralAgent) {
  ...
  var peripheralSessionId = '${DateTime.now().millisecondsSinceEpoch}';
  var printerIdentifier = 'FAKE_PRINTER';
  var scannerIdentifier = 'FAKE_SCANNER';

  // Home page dictated from command line for integration testing
  var homeRoute = const String.fromEnvironment(
    'app_home',
    defaultValue: 'WelcomePage',
  );

  var initialRoute =
      (homeRoute == 'WelcomePage' ? AppRouting.welcome : AppRouting.login);
